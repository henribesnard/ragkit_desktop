      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        <div className="w-64 flex-shrink-0 border-r border-gray-200 dark:border-gray-700 pr-4">
          <nav className="space-y-1">
            <button onClick={() => setActiveSection("general")} className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md ${activeSection === "general" ? "bg-blue-50 text-blue-700" : "text-gray-700 hover:bg-gray-100"}`}><Layers className="w-4 h-4" />Général</button>
            <div className="pt-4 pb-2"><span className="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Avancé</span></div>
            <button onClick={() => setActiveSection("ingestion")} className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md ${activeSection === "ingestion" ? "bg-blue-50 text-blue-700" : "text-gray-700 hover:bg-gray-100"}`}><FileText className="w-4 h-4" />Ingestion & Préprocessing</button>
