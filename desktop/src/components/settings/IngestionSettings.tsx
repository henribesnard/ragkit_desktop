        ...
        <div className="space-y-4">
            ...
            {activeTab === "config" && (
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
                    ...
                    <section>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 border-b pb-2 border-gray-100 dark:border-gray-800">Parsing & OCR</h3>
                        <ParsingSettings config={config} onChange={handleConfigChange} />
                    </section>

                    <section>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 border-b pb-2 border-gray-100 dark:border-gray-800">Prétraitement</h3>
