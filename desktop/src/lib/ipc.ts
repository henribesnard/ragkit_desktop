...
export const ipc = {
  ...
  renameConversation: (id: string, title: string) => invoke("rename_conversation", { conversation_id: id, title }),
  archiveConversation: (id: string, archived: boolean) => invoke("archive_conversation", { conversation_id: id, archived }),
  deleteConversation: (id: string) => invoke("delete_conversation", { conversation_id: id }),
