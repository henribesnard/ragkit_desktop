...
export const ipc = {
  ...
  newConversation: (conversationId?: string) => invoke("new_conversation", { conversationId }),
  getConversationHistory: (conversationId?: string) => invoke("get_conversation_history", { conversationId }),
  generateConversationTitle: (conversationId: string) => invoke<{ title: string }>("generate_title", { payload: { conversationId } }),
