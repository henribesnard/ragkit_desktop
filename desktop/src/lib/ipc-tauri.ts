/**
 * Tauri IPC implementation — used when running inside the Tauri desktop shell.
 * Each method calls the Rust backend via `invoke()`.
 */
...
export const tauriIpc: IpcInterface = {
